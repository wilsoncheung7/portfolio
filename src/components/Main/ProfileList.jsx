...
import { DATA } from '../DataProvider/WorkData'
        ...
        DATA.map((data) => {
          return (
            <div>
              <h2>{data.name}</h2>
              <h5>{data.period}</h5>
              <div className="fakeimg" style={{ height: 500, width: 300, background: '#aaa' }}>
                <img style={{ height: 500, width: '100%' }} src={data.img_url} alt={data.img_alt} />
              </div>
              <p>{data.location}</p>
